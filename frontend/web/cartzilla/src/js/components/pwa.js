...
export default (() => {
  ...
  const SETTINGS = {
    appName: 'Trendlly',
    remindAfterHours: 0, // Number of hours to wait before showing the prompt again
        ...
        <div class="modal-dialog">
          <div class="modal-content">
            <div class="modal-body text-center">
              ...
              <h5 class="pt-1" id="${promptId}Label">Install Trendlly app</h5>
              ${browser === 'Safari' ? `<p class="fs-sm mb-0">Add Trendlly to your home screen for quick and easy access to your shopping anytime, anywhere! Tap the <span class="fw-semibold">"Share"</span> icon in Safari and select <span class="fw-semibold">"Add to Home Screen"</span> from the options.</p>` : `<p class="fs-sm mb-0">Add Trendlly to your home screen for quick and easy access to your shopping anytime, anywhere!</p>`}
